...
namespace DampGUI
{
    ...
    public class Friend : ModelBase<Friend>
    {
        ...
        public Friend(string aName, string aDescription, string aGender, string aCity, string aCountry,
                      string aLanguage, ObservableCollection<string> aAchivementsComplete, Photo aPhoto)
        {
            Name = aName;
            ...
            Country = aCountry;
            Language = aLanguage;
            AchivementsComplete = aAchivementsComplete;
            Photo = aPhoto;
        }
